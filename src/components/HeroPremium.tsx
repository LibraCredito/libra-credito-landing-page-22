...
const HeroPremium: React.FC = () => {
  ...
  return (
  <section
      className="min-h-[60vh] md:min-h-[65vh] lg:min-h-[70vh] xl:min-h-[calc(100vh-280px)] py-8 md:py-16 bg-white relative flex flex-col justify-center"
    ...
    >
      <div className="container mx-auto px-4 md:px-8 relative z-10 flex-grow flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Lado Esquerdo */}
          <div className="text-[#003399] max-w-lg mx-auto space-y-6 md:space-y-8 text-center flex flex-col items-center">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2 md:space-y-3 text-sm md:text-base lg:text-lg text-[#003399] font-medium">
                ...
                <li className="list-none">
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full max-w-sm mx-auto pt-4 sm:pt-6">
                    <HeroButton
